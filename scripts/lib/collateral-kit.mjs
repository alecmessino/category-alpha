...
/* ---- masthead ------------------------------------------------------------------ */
.mh{border-bottom:1.6px solid var(--ink-900);padding-bottom:var(--sp-1);margin-bottom:var(--sp-2)}
...
.mh-title{font-family:var(--font-display);font-size:12.4px;font-weight:700;line-height:1.1;
...
/* ---- section furniture ---------------------------------------------------------- */
.sec{margin-top:var(--sp-2)}
.sec-hd{display:flex;align-items:baseline;gap:var(--sp-3);border-left:2.5px solid var(--ink-900);
  padding-left:var(--sp-3);margin-bottom:var(--sp-2)}
.sec-hd h2{font-family:var(--font-mono);font-size:7.5px;font-weight:600;letter-spacing:1.5px;
...
.ledger td{text-align:right;padding:1.4px var(--sp-3);border-bottom:1px solid var(--line-200);
  white-space:nowrap}
...
/* ---- cite ----------------------------------------------------------------------- */
.cite{border-top:1px solid var(--ink-900);margin-top:var(--sp-2);padding-top:var(--sp-1)}
...
/* ---- boxes ----------------------------------------------------------------------- */
.box{border:1px solid var(--line-300);border-radius:4px;padding:4px 5px;background:var(--white)}
...
.box h3{font-family:var(--font-mono);font-size:6.5px;letter-spacing:.9px;text-transform:uppercase;
  margin:0 0 var(--sp-1);color:var(--ink-900)}
.box p{margin:0 0 var(--sp-1);font-size:7.2px;line-height:1.26;color:var(--ink-700)}
.box p:last-child{margin-bottom:0}
.box ul{margin:0;padding-left:9px;font-size:7.2px;line-height:1.24;color:var(--ink-700)}
...
.card .lf{font-family:var(--font-mono);font-size:5.6px;color:var(--ink-900);
...
.tile{border:1px solid var(--line-300);border-radius:4px;padding:4px 5px;background:var(--paper-50)}
...
.plate-ft{display:flex;flex-wrap:wrap;gap:0 var(--sp-4);padding:1px var(--sp-4);
...
.rail{display:grid;grid-template-columns:repeat(3,1fr);gap:var(--sp-4);border-top:1px solid var(--ink-900);
  border-bottom:1px solid var(--ink-900);padding:var(--sp-1) 0;margin:var(--sp-2) 0}
...
.ledger .prose{font-family:var(--font-sans);font-size:6.8px;line-height:1.22;color:var(--ink-700);
  margin-top:1.5px}
...
.ledger.compact td{padding:0.6px var(--sp-2);font-size:6.6px;line-height:1.18}
.ledger.compact th{padding:1px var(--sp-2);font-size:5.9px}
...
.cmptable td{text-align:left;white-space:normal;vertical-align:top;line-height:1.22;
  font-family:var(--font-sans);font-size:6.9px;padding:1px var(--sp-3)}
...
.cmptable.compact td{font-size:6.5px;padding:0.8px var(--sp-2);line-height:1.18}
...
.citelist .v{font-size:5.2px;line-height:1.18}
.citelist .u{font-size:5.1px}
.citelist .k{font-size:6px}
...
/* ---- footer ----------------------------------------------------------------------- */
.ft{margin-top:auto;border-top:1px solid var(--ink-900);padding-top:2px}
.ft-disclaim{margin:0 0 1px}
.ft-row{display:flex;justify-content:space-between;gap:var(--sp-6);align-items:flex-start}
.ft .l{font-family:var(--font-mono);font-size:5.4px;color:var(--ink-600);letter-spacing:.5px;
...
.fn{font-family:var(--font-mono);font-size:6px;color:var(--ink-600);line-height:1.26;
  margin-top:var(--sp-1)}
