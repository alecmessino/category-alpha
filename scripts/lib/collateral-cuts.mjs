...
export const LEGIBILITY_CUTS = {
  ...
  "B2-97L-energy-weather-trading.html": [
    { kind: "compressed", block: "comparison strip → a WHAT ATLAS ADDS line", px: 129,
      instead: "one sentence closing the refusals section",
      why: "the visual-translation pass put the seasonal-timing quantiles and their range plot at the top of the page as its hero; D carries the strip in full" },
